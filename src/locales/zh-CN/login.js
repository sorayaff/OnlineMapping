export default {
  ...
  'app.register.register.title': '注册 CACSD',
  ...
  'app.register-result.back-login': '返回登陆',
  ...
  'validation.password.strength.msg': '请至少输入 8 个字符,包含字母和数字。请不要使用容易被猜到的密码。',
  ...
  'validation.firstName.required': '请输入名！',
  'validation.lastName.required': '请输入姓！',
