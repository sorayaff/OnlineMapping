export default {
  ...
  'validation.password.strength.msg':
    "Please enter at least 8 characters and contains digits and letters. Don't use passwords that are easy to guess.",
  ...
  'validation.lastName.wrong-format': 'Malformed last name!',
  'validation.firstName.wrong-format': 'Malformed first name!',
