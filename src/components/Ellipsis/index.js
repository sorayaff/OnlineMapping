...
const getTooltip = ({ tooltip, overlayStyle, title, children,didEllipsis }) => {
  if (tooltip && didEllipsis) {
...
// real useful component
const EllipsisText = ({ text, length, tooltip, didEllipsis,fullWidthRecognition, ...other }) => {
...
export default class Ellipsis extends Component {
  ...
  render() {
    const { text, targetCount ,didEllipsis} = this.state;
    const {
      children,
      lines,
      length,
