...
class LoginPage extends Component {
  ...
  handleSubmit = (err, values) => {
    let service = window.location.href||'CASA';
    const {userPosition}=this.props.global
    if (!err) {
      const {dispatch} = this.props;
      dispatch({
        type: 'login/login',
        payload: {
          ...values,
          // ip:userPosition.ip|| returnCitySN.cip,  // eslint-disable-line
          // city:userPosition.country|| returnCitySN.city, // eslint-disable-line
          service: service,
        },
      });
    }
